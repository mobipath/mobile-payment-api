...
Create: <https://api.mobipath.com/api/v1/payment/ussd/beta/create>

Execute: <https://api.mobipath.com/api/v1/payment/ussd/beta/execute>

Status: <https://api.mobipath.com/api/v1/payment/ussd/beta/status>
